...
class ListaController extends BaseController {
	...
	{	
		 ...
		 $lista->principal = Input::get('principal');
		 $lista->save();
	...
	//obter formulários a partir de uma lista	
	public function getForm($idLista){
		 
		 $data['lista'] = Lista::find($idLista); 
		 
		 return View::make('form.construtor',$data); 
		 
	}
	
	//obter formulario
	public function getSubform($idFormulario){
		 
		 $data['formulario'] = Formulario::find($idFormulario); 
		 
		 return View::make('form.construtor2',$data); 
